 ...
 */
@TrackerHandler(name = "BackUps", needsManualInput = true, url = "https://back-ups.me/")
public class BackUpsHandler extends AbstractTrackerHandler {
     ...
     */
    public BackUpsHandler(final ChromeDriver driver, final Collection<String> trackerUrls) {
