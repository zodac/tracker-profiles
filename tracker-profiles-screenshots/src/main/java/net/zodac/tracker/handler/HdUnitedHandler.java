...
/**
 * Implementation of {@link AbstractTrackerHandler} for the {@code HDUnited} tracker.
 */
@TrackerHandler(name = "HDUnited", url = "https://hd-united.vn/")
public class HdUnitedHandler extends AbstractTrackerHandler {
     ...
     */
    public HdUnitedHandler(final ChromeDriver driver, final Collection<String> trackerUrls) {
